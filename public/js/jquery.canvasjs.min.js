(function() {
    ...
    function ia(a, d) {
        ...
        b.setAttribute("class", "chart-canvas");
        ta(b, a, d);
    ...
    function z(a, d) {
        ...
        if (this.container = "string" === typeof this._containerId ? document.getElementById(this._containerId) : this._containerId) {
            ...
            this._canvasJSContainer.setAttribute("class", "chart-container");
            ...
            this.canvas.getContext && (this._canvasJSContainer.appendChild(this.canvas), this.ctx = this.canvas.getContext("2d"), this.ctx.textBaseline = "top", Sa(this.ctx), v ? this.plotArea.ctx = this.ctx : (this.plotArea.canvas = ia(c, f), this.plotArea.canvas.style.position = "absolute", this.plotArea.canvas.setAttribute("class", "plotAreaCanvas"), this._canvasJSContainer.appendChild(this.plotArea.canvas),
                ...
                }), this._toolBar = document.createElement("div"), this._toolBar.setAttribute("class", "chart-toolbar"), this._toolBar.style.cssText =
    ...
    var J = {},
        ...
        ua = 1,
        P = Na ? Ba / ua : 1,
        Oa = window && window.location && window.location.href && window.location.href.indexOf && -1 !== window.location.href.indexOf(""),
        Va = {
            reset: {
    ...
    z.prototype.print = function() {
        ...
        d.setAttribute("class", "chart-print-frame");
    ...
    V.prototype._initialize = function() {
        if (this.enabled) {
            ...
            this.container.setAttribute("class", "chart-tooltip");
...
(function(b, c, d, e) {
    b.fn.CanvasJSChart = function(a) {
        if (a) {
            ...
            b.children(".chart-container").data("canvasjsChartRef", a);
            a.render();
            return this
        }
        return this.first().children(".chart-container").data("canvasjsChartRef")
    }
